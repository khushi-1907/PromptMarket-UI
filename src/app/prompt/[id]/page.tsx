...
export default function PromptDetails() {
    ...
    return (
        <div className="bg-background-light text-[#0d101b] antialiased min-h-screen flex">
            ...
            <nav className="w-20 glass-effect border-r border-white/20 hidden lg:flex flex-col items-center sticky top-0 h-screen py-6 gap-6 shrink-0">
                ...
                <div className="flex flex-col items-center gap-2 w-full px-3">
                    <Link href="/" className="flex flex-col items-center gap-1 w-full rounded-xl py-3 text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition-all">
